...
class GetAdminShipData
{
    /** @var BackendQuoteSession */
    private $backendQuoteSession;

    /** @var AdminShipData | null */
    private $adminShipData;
    ...
    {
        if (!$this->adminShipData) {
            $this->adminShipData = $this->backendQuoteSession->getShqAdminShipData();
        }
        return $this->adminShipData;
    }
}
