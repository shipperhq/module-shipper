...
class Detail extends \Magento\Framework\Model\AbstractExtensibleModel
{
    ...
    public function __construct(
        \ShipperHQ\Shipper\Model\ResourceModel\Order\Detail\CollectionFactory $orderDetailCollectionFactory,
     ...
     * @return mixed
     */
    public function loadByCarrierGroupIdAndOrder($carrierGroupId, $orderId)
    {
    ...
    {
        $this->_init('ShipperHQ\Shipper\Model\ResourceModel\Order\Detail');
    }
}
